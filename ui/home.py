...
"color: rgba(0, 0, 0, 140);")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.explain_title.setText(QCoreApplication.translate("MainWindow", u"Virtual Try On  \u2013  A Graphical User Interface For VirtualTryOn", None))
        ...
        self.save_res_button.setText(QCoreApplication.translate("MainWindow", u"保存结果", None))
